...
# Public Methods
    ...
    def get_correlInputHeader(self, header=[]):
        ...
        String.append('')
        String.append('! top')
        String.append('open unit 1 read card name %s' % self.rtfFile)
        String.append('read rtf card unit 1')
        String.append('close unit 1')
        String.append('')
        String.append('! par')
        String.append('open unit 1 read card name %s' % self.prmFile)
        String.append('read para card unit 1')
        String.append('close unit 1')
        String.append('')
        String.append('! psf')
        String.append('open unit 1 read card name %s' % self.psfFile)
        String.append('read psf card unit 1')
        String.append('close unit 1')
        String.append('')
        String.append('! crd')
        String.append('open unit 1 read card name %s' % self.crdFile)
